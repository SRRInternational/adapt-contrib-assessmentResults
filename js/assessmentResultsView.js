  ...
  var AssessmentResultsView = ComponentView.extend(
    {
      ...
      postRender: function () {
        ...
        var assessmentModel = Adapt.assessment.get(
          this.model.get("_assessmentId")
        );
        ...
        if (state.isPass) {
          ...
          if (
            _sLockType == "sequential" &&
            this.model.get("_exit")._isEnabled == true
          ) {
      ...
      onNextClicked: function () {
        ...
        Backbone.history.navigate("#/id/" + this.model.get("_next")._pageId, {
          trigger: true,
        });
      },
